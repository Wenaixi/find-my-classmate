...
export function App() {
  ...
  return (
    <div className="app-shell" data-od-id="app-shell">
      ...
      <footer className="site-footer" data-od-id="site-footer"><span data-od-id="footer-brand">FINDMYCLASSMATE / ARCHIVE ACCESS</span><span data-od-id="demo-note">高一 / 高二最新数据 · Go 单体服务</span></footer>
    </div>
  );
}
