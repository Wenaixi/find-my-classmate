...
export function App() {
  ...
  return (
    <div className="app-shell" data-od-id="app-shell">
      ...
      <main id="top">
        <section className="hero" data-od-id="hero">
          ...
          <form className="search-wrap" data-od-id="search-form" onSubmit={submit}>
            ...
            <BorderBeam size="md" colorVariant="colorful" theme="dark" borderRadius={999} duration={1.8} brightness={1.9} saturation={2.4} hueRange={360} strength={1}>
      ...
      <footer className="site-footer" data-od-id="site-footer"><div className="footer-stack"><span data-od-id="footer-brand">FINDMYCLASSMATE / ARCHIVE ACCESS</span><span className="footer-fine" data-od-id="footer-source">数据来源：福清一中公示数据提取</span><span className="footer-fine" data-od-id="footer-team">运营团队：福清一中信息社</span></div><span data-od-id="demo-note">高一 / 高二最新数据 · Go 单体服务</span></footer>
    </div>
  );
}
