  ...
  return (
    <div className="app-shell" data-od-id="app-shell">
      ...
      <main id="top">
        ...
        <section className="privacy-band" id="privacy" data-od-id="privacy-band"><div className="footer-label" data-od-id="privacy-label">隐私边界 / PRIVATE BY DEFAULT</div><p data-od-id="privacy-copy">名单仅用于班级查询。查询内容不写入本地存储，也不会通过页面地址保留。数据处理：福清一中信息社。</p></section>
      </main>
